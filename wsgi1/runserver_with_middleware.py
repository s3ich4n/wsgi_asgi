...
from pep_example.middlewares.latin import Latinator
...
if __name__ == '__main__':
    ...
    parser.add_argument('run', choices=['function', 'class'])
    args = parser.parse_args()

    if args.run == "function":
        from pep_example.with_middleware.app_base import easy_application
        run_with_cgi(Latinator(easy_application))

    else:
        from pep_example.with_middleware.app_base_class import AppClass
